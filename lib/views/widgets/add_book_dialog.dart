...
class AddBookDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final CreateBookModel bookModel =
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    controller:
                        TextEditingController(text: createBookModel?.title),
                  ),
                ),
                SizedBox(
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    controller:
                        TextEditingController(text: createBookModel?.author),
                  ),
                ),
                SizedBox(
                  height: MediaQuery.sizeOf(context).height / 35,
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    controller:
                        TextEditingController(text: createBookModel?.publisher),
                  ),
                ),
                SizedBox(
                  height: MediaQuery.sizeOf(context).height / 35,
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    controller: TextEditingController(
                        text: createBookModel?.description),
                  ...
                  child: Center(
                    child: Obx(() => image.value.isEmpty
                        ? createBookModel == null
                            ? const SizedBox()
                            : Image.network(createBookModel?.imageUrl ?? "")
                        : Image.memory(
                            image.value,
                          )),
                  ),
